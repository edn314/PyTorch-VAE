...
class VanillaAE(BaseVAE):
    ...
    def __init__(self,
        ...
        self.fc_mu = nn.Linear(hidden_dims[-1]*64, latent_dim) # CHANGE FOR DIFFERENT DATASETS
        self.fc_var = nn.Linear(hidden_dims[-1]*64, latent_dim) # CHANGE FOR DIFFERENT DATASETS


        # Build Decoder
        modules = []

        self.decoder_input = nn.Linear(latent_dim, hidden_dims[-1]*64) # CHANGE FOR DIFFERENT DATASETS
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        result = result.view(-1, 512, 8, 8) # CHANGE FOR DIFFERENT DATASETS
        # ### DEBUG #####
